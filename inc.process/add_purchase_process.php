...
if(isset($_POST["product_name"]))
{
 ...
 {  
  ...
  (company_name, dc_no, dc_date, order_no, order_date, product_name, ream, unit_price, total) 
  VALUES (:company_name, :dc_no, :dc_date, :order_no, :order_date, :product_name, :ream, :unit_price, :total)
  ";
